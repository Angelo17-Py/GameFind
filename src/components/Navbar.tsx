                        ...
                        <div className="flex items-center gap-2 sm:gap-4 pr-2 sm:pr-4 border-r border-white/10">
                            ...
                            >
                                ...
                                <div className="relative">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className="text-red-500 group-hover:scale-110 transition-transform">
                                        <path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z" />
                                    </svg>
                                    {favCount > 0 && (
                                        <span className="absolute -top-1.5 -right-1.5 bg-white text-red-600 text-[7px] font-black px-1 rounded shadow-lg">
                                            {favCount}
                                        </span>
                                    )}
                                </div>
